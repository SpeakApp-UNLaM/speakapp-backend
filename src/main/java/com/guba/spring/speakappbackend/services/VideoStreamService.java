...
public class VideoStreamService {
    ...
    private final VideoArticulationStorageRepository videoArticulationStorageRepository;
    ...
    public FileInputStream getVideoHowFileInputStream(final String filename) throws IOException {
        final Resource resource = this.videoArticulationStorageRepository.getAudioByFilename(filename);
        logger.info("path of filename {}, size {}", resource.getFile().getAbsolutePath(), resource.getFile().length());
        return new FileInputStream(resource.getFile());
    }

    public Resource getVideoHowResource(final String filename) {
        return this.videoArticulationStorageRepository.getAudioByFilename(filename);
    }
}